...
- Testimony **won't be relevant** if we don't trust the sources, so **trust** here is essential for belief acquisition [@hendriksTrustScienceScience2016].
...
- **Target-dependent thinking**: using sci and rel for addressing [**different aspects**]{.alert} of a phenomenon
- **Synthetic thinking**: [**partially**]{.alert} integrate sci and rel by loosely combining them
- **Integrative thinking**: [**fully**]{.alert} integrate sci and rel into a unified, coherent explanation
